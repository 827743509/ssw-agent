...
"""
from ssw.config import RETRIEVAL_RECALL_TOP_K
from ssw.subagents.rag.rag_state import RAGState
from ssw.subagents.rag.retrieved.hybrid_retriever import HybridRetriever
from ssw.subagents.rag.retrieved.vector_retriever import RetrievedChunk


async def retrieve(state: RAGState) -> RAGState:
    retriever = HybridRetriever()
    recall_top_k = RETRIEVAL_RECALL_TOP_K
